...
class SignupForm(FlaskForm):
    ...
    password = PasswordField('Password',validators=[DataRequired("Please enter a password."), Length(min=6, message="Passwords must be 6 characters or more"),EqualTo('verify_password', message="Passwords does not match")])
